...
from omdbapi.api.resources import MediaResource, MiniEpisodeResource
...
def find(string: str, kind: str = 'series') -> Optional[MediaResource]:
	"""
...
def get(string: str) -> MediaResource:
	"""
